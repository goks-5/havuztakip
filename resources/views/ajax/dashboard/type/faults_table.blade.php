...
<h5>Durumlar</h5>
 <div class="col-xs-3">
  ...
  <div class="col-xs-3">
    <label class="control-label">Bakıma Başlandı {{ $setting['status'][1] ?? '0' }}</label>
...
<div class="col-xs-3">
  <label class="control-label">Firma Yönlendirildi {{ $setting['status'][2] ?? '0' }}</label>
...
<div class="col-xs-3">
  <label class="control-label">Malzeme Bekliyor {{ $setting['status'][3] ?? '0' }}</label>
...
<div class="col-xs-3">
  <label class="control-label">Tamamlandı {{ $setting['status'][4] ?? '0' }}</label>
