...
!function(e) {
  ...
  e.serializeJSON = {
      ...
      setupOpts: function(n) {
          ...
          for (var i in n)
              if (-1 === t.indexOf(i))
                  throw new Error("serializeJSON ERROR: invalid option '" + i + "'. Please use one of " + t.join(", "));
      ...
      serializeArray: function(a, u) {
          ...
          return a.map(function() {
              ...
              var a = e(this)
                , l = a.val()
                , p = this.type;
              return null == l ? null : (i.test(p) && !this.checked && (l = s.getCheckboxUncheckedValue(a, u)),
              o(l) ? e.map(l, function(e) {
                  return {
                      name: t.name,
                      value: e.replace(n, "\r\n"),
                      el: t
      ...
      getCheckboxUncheckedValue: function(e, n) {
          ...
          return null == r && (r = n.checkboxUncheckedValue),
          r
      },
      applyTypeFunc: function(e, n, r, t, i) {
          var u = i[r];
          if (!u)
              throw new Error("serializeJSON ERROR: Invalid type " + r + " found in input name '" + e + "', please use one of " + a(i).join(", "));
          return u(n, t)
      },
      ...
      deepSet: function(n, r, t, i) {
          ...
          if (1 !== r.length) {
              ...
              "" === f ? !s(n[p]) && o(n[p]) || (n[p] = []) : i.useIntKeysAsArrayIndex && l(f) ? !s(n[p]) && o(n[p]) || (n[p] = []) : !s(n[p]) && u(n[p]) || (n[p] = {}),
              a.deepSet(n[p], c, t, i)
          } else
              "" === p ? n.push(t) : n[p] = t
      },
