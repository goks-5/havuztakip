                ...
                <div class="row" style="margin-top: 30px; margin-bottom: 5px;">
                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        <h3 style="color: #444; font-weight: 600; margin: 0;">
                            İşlemdeki İş Emirleri
                        </h3>
                    </div>
                    
                    <!-- Sağ tarafta arama kutusu -->
                    <div class="col-md-8 text-right">
                        <form action="{{ route('islemdekiler.browse') }}" method="GET" class="form-inline" style="justify-content: flex-end;">
                            <input type="text"
                                   name="search"
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            @foreach($faults as $fault)
                                @php
                                    // Statüye göre renk ayarlaması:
                                    if ($fault->status == 'Bekliyor |0|') {
                                        $rowBgColor = '#ffe5cc'; // Açık turuncu
                                    } elseif ($fault->status == 'Bakıma Başlandı |0|') {
                                ...
                                <tr style="background-color: {{ $rowBgColor }}; color: {{ $rowTextColor }};">
                                    ...
                                    <!-- İşlemler sütunu: Göster, Düzenle, Sil, İşlem Gir -->
                                    <td>
                                        <!-- Göster Butonu -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <form action="{{ route('yeni-gelen-is-emirleri.process', $fault->id) }}"
                                                    method="POST">
                                                @csrf
                                                <!-- Modal Header -->
                                                <div class="modal-header bg-primary text-white" style="position: relative; padding-top: 1rem; padding-bottom: 1rem;">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-dismiss="modal"
                                                            aria-label="Kapat"
                                                            style="position: absolute; top: 0.5rem; right: 1rem; outline: none;">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <!-- Kaydet butonunun yazısını koyulaştırmak için .font-weight-bold ekledik -->
