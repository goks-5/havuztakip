            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-edit-add" action="{{ route('sanalkaydet') }}" method="POST"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group  col-md-12 ">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Takma Ad"
                                ...
                                <div class="form-group  col-md-12 ">
                                    ...
                                    <input type="hidden" class="form-control" id="form-tags" name="tags"
                                        value="{{ isset($device->tags) ? $device->tags : '' }}">
                                    <input type="hidden" class="form-control" id="form-formula" name="formula"
                                        value="{{ isset($device->formula) ? $device->formula : '' }}">
                                    <input type="hidden" class="form-control" id="form-type" name="type"
                                        value="{{ isset($device->type) ? $device->type : '' }}">
                                    <div class='con_tags'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input multiple_tags" type="checkbox"
                                                            data-index="100" data-name=" Saatlik" value="Sayaç 1 Saatlik"
                                                            id="tags_100" name="__tags[100]">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input multiple_tags" type="checkbox"
                                                            data-index="200" data-name=" Günlük" value="Sayaç 1 Günlük"
                                                            id="tags_200" name="__tags[200]">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input multiple_tags" type="checkbox"
                                                            data-index="300" data-name=" Haftalık"
                                                            value="Sayaç 1 Haftalık" id="tags_300" name="__tags[300]">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input multiple_tags" type="checkbox"
                                                            data-index="400" data-name=" Aylık" value="Sayaç 1 Aylık"
                                                            id="tags_400" name="__tags[400]">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input multiple_tags" type="checkbox"
                                                            data-index="500" data-name=" Yıllık" value="Sayaç 1 Yıllık"
                                                            id="tags_500" name="__tags[500]">
                                                        <label class="form-check-label" for="tags_500">Yıllık</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control formul" name="__formuls[]"
                                                        placeholder="Formül">
                                    ...
                                    <div class="form-group">
                                        <input type="button" class="btn btn-warning" value='Yeni Etiket Ekle'
                                            id='add_tags' />
                                        <input type="button" class="btn btn-danger" value='Son Etiket Sil'
                                            id='remove_tags' />
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('dblclick', ".islem", function() {
                ...
                $(this).closest('div').prev().find('input').val($(this).closest('div').prev().find('input')
                    .val() + $(this).val());
            ...
            $(document).on('keyup', ".inputFilter", function() {
                var filter = $(this).val();
                console.log(filter);
                console.log($(this).nextAll('.islem:first'));
