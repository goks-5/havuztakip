...
foreach($dataTypeContent as $data){
  ...
  $points= json_decode($data->data_tags,true);
}
                                    ...
                                    <tr>
                                      ...
                                      ->first();
                                        ...
                                        if ($data->end_time > $data->start_time) {
                                            $et = date('Y-m-d H:i:s', strtotime($data->end_time));

                                            $value =  Cache::remember('pt_' . $data->id .'_'. $device[$point['device']]->name . '_' . $devicetags[$point['device_index']],172800, function () use ($point , $st , $et)  {
