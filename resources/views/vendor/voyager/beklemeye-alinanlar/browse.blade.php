    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row" style="margin-top: 30px; margin-bottom: 5 px;">
                    <!-- Sol tarafta başlık -->
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            @foreach($faults as $fault)
                                @php
                                    // Duruma göre satır rengi belirleme:
                                    // "Firma Yönlendirildi |2|" için: Açık mavi, "Malzeme Bekliyor |2|" için: Bir tık koyu mavi
