...
<div class="form-group row">
  ...
  <div class="col-xs-3"> <input type="number" name="setting[low]" class="form-control"  value="{{$settings['low'] ?? '25'}}"/>
  </div>
  <div class="col-xs-3">
    <label class="control-label">Yüksek Seviye Başlangıcı</label>
  </div>
  <div class="col-xs-3"> <input type="number" name="setting[high]" class="form-control"  value="{{$settings['high'] ?? '75'}}"/>
  </div>
